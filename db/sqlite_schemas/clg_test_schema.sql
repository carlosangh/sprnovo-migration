-- Schema extraído de: /home/cadu/ciclologico_production/backend_v2/clg_test.db
-- Data: 1756737678.4898279
...
CREATE INDEX ix_prices_commodity ON prices (commodity);

CREATE INDEX ix_prices_id ON prices (id);

CREATE INDEX ix_prices_market ON prices (market);
...
CREATE TABLE prices (
	...
	source TEXT, 
	PRIMARY KEY (id), 
	CONSTRAINT unique_price_record UNIQUE (ts, commodity, market, contract, source)
);
